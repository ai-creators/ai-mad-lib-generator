...
export class SetupEntities1704136779386 implements MigrationInterface {
    name = 'SetupEntities1704136779386'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "adlib_response" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "oldAdlibResponseId" character varying, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "adlibId" uuid, "createdById" uuid, CONSTRAINT "UQ_f4c155b1f54b0714b759631581a" UNIQUE ("oldAdlibResponseId"), CONSTRAINT "PK_4561bf145faaa69003979da0062" PRIMARY KEY ("id"))`);
