...
export class SetupAdlibs1705210814715 implements MigrationInterface {
    name = 'SetupAdlibs1705210814715'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "reaction" ("accountId" uuid NOT NULL, "adlibId" uuid NOT NULL, "reactionType" "public"."reaction_reactiontype_enum" NOT NULL DEFAULT 'Like', "hasReacted" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_7ace9e3b3582f1dd02a308e1741" PRIMARY KEY ("accountId", "adlibId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "notification" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."notification_type_enum" NOT NULL, "status" "public"."notification_status_enum" NOT NULL DEFAULT 'Hidden', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "adlibId" uuid, "accountId" uuid, "createdById" uuid, CONSTRAINT "PK_705b6c7cdf9b2c2ff7ac7872cb7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "reaction" ADD CONSTRAINT "FK_e5515ba3a249e96b49064dcc95a" FOREIGN KEY ("accountId") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "notification" ADD CONSTRAINT "FK_9b1c33b910840a77f16721825d0" FOREIGN KEY ("adlibId") REFERENCES "adlib"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "notification" ADD CONSTRAINT "FK_ab94760702f01d400c4e845fbe6" FOREIGN KEY ("createdById") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "notification" DROP CONSTRAINT "FK_9b1c33b910840a77f16721825d0"`);
        ...
        await queryRunner.query(`ALTER TABLE "reaction" DROP CONSTRAINT "FK_e5515ba3a249e96b49064dcc95a"`);
