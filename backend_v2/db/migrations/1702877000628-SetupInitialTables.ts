...
export class SetupInitialTables1702877000628 implements MigrationInterface {
    name = 'SetupInitialTables1702877000628'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "adlib_response" ("id" SERIAL NOT NULL, "adlibId" integer, CONSTRAINT "PK_4561bf145faaa69003979da0062" PRIMARY KEY ("id"))`);
