...
export class SetupAdlibsCategoriesResponses1706725501045 implements MigrationInterface {
    name = 'SetupAdlibsCategoriesResponses1706725501045'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "adlib" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "prompt" character varying NOT NULL, "text" character varying NOT NULL, "isHidden" boolean NOT NULL DEFAULT false, "isPg" boolean NOT NULL DEFAULT false, "isFeatured" boolean NOT NULL DEFAULT false, "temperature" numeric(10,2) NOT NULL DEFAULT '0.7', "topP" numeric(10,2) NOT NULL DEFAULT '1', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_18ce95da5b60674008c6ddd70a6" PRIMARY KEY ("id"))`);
