  ...
  describe("POST /generate/madlib", function () {
    ...
    it("should return 500 if there is an error with the OpenAI API", function (done) {
      ...
      it("should return 200 and a completed MadLib with multiple prompts", function (done) {
        const data = {
          template:
            "My favorite color is {color} and my favorite food is {food}.",
          prompts: {
            color: "purple",
            food: "pizza",
          },
        ...
        request(app)
          ...
          .end(function (err, res) {
            ...
            assert.equal(
              res.body.completedMadLib,
              "My favorite color is purple and my favorite food is pizza."
            );
            done();
          });
      });
      ...
      it("should return 200 and a completed MadLib with a long template and prompts", function (done) {
        const data = {
          template:
            "I like to {verb} {adverb} {adjective} {noun} when it is {weather} outside.",
          prompts: {
            verb: "eat",
            adverb: "quickly",
            adjective: "spicy",
        ...
        request(app)
          ...
          .end(function (err, res) {
            ...
            assert.equal(
              res.body.completedMadLib,
              "I like to eat quickly spicy tacos when it is sunny outside."
            );
            done();
          });
      });
